select DISTINCT a.dopes as MOVIMENTO ,mascnum as CODIGO,Convert(varchar(max),a.obses) as empresa, B.rclis as CLIENTE,
			d.NOPS AS OP,C.CPROS AS PRODUTO, D.dpros AS DESCRIÇAO,A.PRAZOENTS AS ENTREGA,C.qtds AS QUANTIDADE, E.grupods AS STATUS,
...
where a.dopes IN ('pedido FABRICA','PEDIDO ENCOMENDA','PEDIDO PILOTO','Ped Acresc Producao','ENTRADA CONSERTO    ',
