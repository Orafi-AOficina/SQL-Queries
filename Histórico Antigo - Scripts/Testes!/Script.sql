select DISTINCT a.dopes as MOVIMENTO, B.rclis as CLIENTE,d.NOPS AS OP,C.CPROS AS PRODUTO, D.dpros AS DESCRIÇAO,A.PRAZOENTS AS ENTREGA,C.qtds AS QUANTIDADE, E.grupods AS STATUS,
