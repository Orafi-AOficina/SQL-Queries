SELECT CAST(A.datas as date) as 'Data Compra',A.nfs, A.titulos, A.contas,B.rclis as 'Fornecedor', G.contas as 'Código CC',H.rclis as 'Centro Custo', A.valors as 'Valor_Original', 
	E.valos as 'Valor_Pago', E.acertos as 'Pagamento', F.datarcs as 'Data Pagamento', A.hist2s as 'Observação', C.fpags as 'Pagto', 
	G.usualts AS 'Usuário', E.empdopnums as 'Chave_Mae_Financeiro', A.emps, CAST(A.vencs AS date) AS 'Vencimento',A.hists as 'Hist1'
FROM SigMvCcr A
